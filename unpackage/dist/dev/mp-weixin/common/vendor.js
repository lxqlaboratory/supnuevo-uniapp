...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"supnuevo-uniapp","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
function getSupnuevoBuyerPriceModifyList(data) {
  return _request.default.request({
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.login = login;exports.getMerchantInitInfoMobile = getMerchantInitInfoMobile;exports.getSupnuevoMerchantInfoMobile = getSupnuevoMerchantInfoMobile;exports.updateMerchantShopNameMobile = updateMerchantShopNameMobile;exports.setMerchantVisibleEachOtherMobile = setMerchantVisibleEachOtherMobile;exports.submitSupnuevoMerchantQuestionInfoMobile = submitSupnuevoMerchantQuestionInfoMobile;exports.addSupnuevoMerchantPriceOperRel = addSupnuevoMerchantPriceOperRel;exports.getRelMerchantListOfMerchantMobile = getRelMerchantListOfMerchantMobile;exports.updateSupnuevoMerchantPriceOperRel = updateSupnuevoMerchantPriceOperRel;var _request = _interopRequireDefault(__webpack_require__(/*! @/common/request.js */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
function getMerchantInitInfoMobile(data) {
  return _request.default.request({
...
function getSupnuevoMerchantInfoMobile(data) {
  return _request.default.request({
...
function updateMerchantShopNameMobile(data) {
  return _request.default.request({
...
function setMerchantVisibleEachOtherMobile(data) {
  return _request.default.request({
...
function submitSupnuevoMerchantQuestionInfoMobile(data) {
  return _request.default.request({
...
function addSupnuevoMerchantPriceOperRel(data) {
  return _request.default.request({
...
function getRelMerchantListOfMerchantMobile(data) {
  return _request.default.request({
...
function updateSupnuevoMerchantPriceOperRel(data) {
  return _request.default.request({
...
var _index = _interopRequireDefault(__webpack_require__(/*! @/request/index.js */ 22));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 19));var _common = __webpack_require__(/*! ./common.js */ 23);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var
  ...
  function Request() {var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};var reqInterceptor = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;var resInterceptor = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;var successHandler = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;var failHandler = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;var completeHandler = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;_classCallCheck(this, Request);
    ...
    if (config.failReject && typeof config.failReject === 'object') {
      ...
      options) {var successHandler,failHandler,completeHandler,task,type,config,that,_args = arguments;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:successHandler = _args.length > 1 && _args[1] !== undefined ? _args[1] : null;failHandler = _args.length > 2 && _args[2] !== undefined ? _args[2] : null;completeHandler = _args.length > 3 && _args[3] !== undefined ? _args[3] : null;
                ...
                }));case 38:case "end":return _context.stop();}}}, _callee, this, [[6, 12]]);}));function request(_x) {return _request.apply(this, arguments);}return request;}() }]);return Request;}();exports.default = Request;
...
requestConfig(_x, _x2) {return _requestConfig.apply(this, arguments);}function _requestConfig() {_requestConfig = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(ins, options) {var header, baseUrl, baseUrl2, config, _cg, _options, type;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            ...
            baseUrl2 = options.baseUrl2 || ins.baseUrl2;
            // config
            config = {};
            if (options.flag === 2) {
              config = {
            ...
            _cg = null;if (!
            ins.requestInterceptor) {_context.next = 24;break;}_context.prev = 7;



            _options = JSON.parse(JSON.stringify(Object.assign({}, options, config)));
            // _cg is tha same object of _options
            _context.next = 11;return ins.requestInterceptor(_options);case 11:_cg = _context.sent;_context.next = 17;break;case 14:_context.prev = 14;_context.t0 = _context["catch"](7);return _context.abrupt("return",
            ...
            _cg.mypReqToCancel) {_context.next = 21;break;}return _context.abrupt("return",
            _cg);case 21:
            ...
            config);case 28:case "end":return _context.stop();}}}, _callee, null, [[7, 14]]);}));return _requestConfig.apply(this, arguments);}
...
!function () {
  ...
  var api = {
    ...
    /**
        ...
        */
    draw: function draw(str, canvas, cavW, cavH, $this) {var cb = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : function () {};var ecc = arguments.length > 6 ? arguments[6] : undefined;
      var that = this;
...
/***/ 41:
/*!******************************************!*\
  !*** D:/vue/supnuevo-uniapp/api/sale.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getSupnuevoBuyerPriceCommodityListByLastFourCodigoMobile = getSupnuevoBuyerPriceCommodityListByLastFourCodigoMobile;exports.gerCommodityInfoByCodigoMobile = gerCommodityInfoByCodigoMobile;exports.saveCommoditySaleMobile = saveCommoditySaleMobile;var _request = _interopRequireDefault(__webpack_require__(/*! @/common/request.js */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

function getSupnuevoBuyerPriceCommodityListByLastFourCodigoMobile(data) {
  return _request.default.request({
...
function gerCommodityInfoByCodigoMobile(data) {
  return _request.default.request({
...
function saveCommoditySaleMobile(data) {
  return _request.default.request({
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _calendar = _interopRequireDefault(__webpack_require__(/*! ./calendar.js */ 412));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var
